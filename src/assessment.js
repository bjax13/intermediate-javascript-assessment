...
// When addIngredient is invoked it saves that ingredient with previously added ingredients and then returns an object that looks like this
//(Replace the parts wrapped in <> with correct data):
// ```
// {
